...
import com.rsl.youresto.databinding.ActivityEstimateBillPrint50Binding
...
class EstimateBillPrint50Activity : AppCompatActivity() {

    private lateinit var mBinding: ActivityEstimateBillPrint50Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_estimate_bill_print50)
        ...
        val tableFactory: TablesViewModelFactory = InjectorUtils.provideTablesViewModelFactory(this)
        mTableViewModel = ViewModelProviders.of(this, tableFactory).get(TablesViewModel::class.java)
        ...
        if (intent != null) {
            ...
            mTableNO = intent.getIntExtra(TABLE_NO, 0)
            mOrderNO = intent.getStringExtra(ORDER_NO)
    ...
    override fun onResume() {
        ...
        this.window!!.setLayout(600, ViewGroup.LayoutParams.WRAP_CONTENT)
...
//        setTaxLabel()
        ...
        mCartViewModel.getRestaurantDetails().observe(this, {
            Log.e("TAG", "setDineInPrintLayout: " )
            when {
                it != null -> {
...
//                    }
                    ...
                    when (mOrderType) {
                        SERVICE_DINE_IN -> {
                            ...
                            mBinding.textViewTableNo.text = "Table: $mTableNO"
                        }
    ...
    private fun printBill() {
        ...
        when {
            mSharedPrefs.getString(SELECTED_BILL_PRINTER_NETWORK_IP, "")!!.isBlank() -> {
