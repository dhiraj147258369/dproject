...
import com.rsl.youresto.ui.main_screen.tables_and_tabs.add_to_tab.tabs.ProductDescriptionFragment
import com.rsl.youresto.ui.main_screen.tables_and_tabs.add_to_tab.tabs.Type1ModifierFragment
import com.rsl.youresto.ui.main_screen.tables_and_tabs.add_to_tab.tabs.modifier_2.Type2ModifierFragment
import com.rsl.youresto.ui.main_screen.tables_and_tabs.add_to_tab.tabs.modifier_3.Type3ModifierFragment
import com.rsl.youresto.ui.main_screen.tables_and_tabs.edit_cart_product.tabs.EditType2ModifierFragment
import com.rsl.youresto.ui.main_screen.tables_and_tabs.edit_cart_product.tabs.EditType3ModifierFragment
...
import com.rsl.youresto.utils.AppConstants.PRODUCT_ID
    ...
    override fun getItem(position: Int): Fragment {
        ...
        return when (position) {
            0 -> {
                ...
                if(mType == 1){
                    when {
                        mProductModel!!.mProductType == 1 -> typeFragment = Type1ModifierFragment()
