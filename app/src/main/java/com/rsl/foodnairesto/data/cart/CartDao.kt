...
interface CartDao {
    ...
    @Query("SELECT * FROM CartProductModel WHERE mLocationID =:mLocationID AND mServerID=:mServerID GROUP BY mCartID")
     fun getLocationPendingOrdersfilter(mLocationID: String, mServerID: String): LiveData<List<CartProductModel>>
