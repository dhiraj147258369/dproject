...
interface TablesDao {
    ...
    @Query("SELECT * FROM TablesModel WHERE mTableType =:mTableType")
    fun getLocalTablesAll( mTableType: Int): LiveData<List<TablesModel>>

    @Query("SELECT * FROM TablesModel WHERE mLocationID = :mLocationID AND mTableType =:mTableType AND mTableNo LIKE :searchText")
    fun getSearchedLocalTables(mLocationID: String, mTableType: Int, searchText: String): LiveData<List<TablesModel>>

    @Query("SELECT * FROM TablesModel WHERE mTableType =:mTableType AND mTitle LIKE :searchText")
    fun getSearchedLocalTablesAll( mTableType: Int, searchText: String): LiveData<List<TablesModel>>
