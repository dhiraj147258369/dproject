...
import com.rsl.foodnairesto.utils.AppConstants.QUICK_SERVICE_CART_ID
import com.rsl.foodnairesto.utils.AppConstants.QUICK_SERVICE_CART_NO
...
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_KITCHEN_PRINTER_NAME
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_KITCHEN_PRINTER_NETWORK_IP
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_KITCHEN_PRINTER_NETWORK_PORT
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_KITCHEN_PRINTER_TYPE
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_KITCHEN_PRINT_PAPER_SIZE
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_LOCATION_ID
import com.rsl.foodnairesto.utils.AppConstants.SELECTED_LOCATION_NAME
...
class AppPreferences(val context: Context) {
    ...
    fun setIsManager(data:Boolean){
        sharedPrefs.edit().apply {
            putBoolean(LOCATION_IS_MANAGER, data)
            apply()
        }
    }
