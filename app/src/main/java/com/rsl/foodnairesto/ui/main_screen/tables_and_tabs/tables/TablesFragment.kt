...
import com.rsl.foodnairesto.databinding.FragmentTablesBinding
...
class TablesFragment : Fragment() {
    ...
    private fun setupTablesRecyclerView() {
        ...
        if(prefs.getIsManager()){
            tablesViewModel.getTablesDataAll("1".toInt()).observe(viewLifecycleOwner) {
                it?.let {
                    mTableAdapter =
            ...
            tablesViewModel.getTablesData(prefs.getSelectedLocation(), "1".toInt())
